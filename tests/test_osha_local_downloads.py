    ...
    def test_run_local_ingest_refreshes_helper_and_sales_outputs(self) -> None:
        ...
        try:
            ...
            config = PipelineConfig(
                ...
                dataset="osha_raw",
                public_project_id="demo-project",
                public_dataset="public_signals",
                rss_project_id="demo-project",
                ...
                city_signals_project_id="demo-project",
                city_signals_dataset="city_signals_raw",
                socrata_app_token="",
                api_key="",
                openfda_api_key="",
                ...
                api_limit=100,
                api_max_pages=1,
                inspection_california_max_pages=2,
                inspection_socal_max_pages=2,
                inspection_bayarea_max_pages=2,
