...
const CONSUMER_NAME_REGEX =
  "\\b(LLC\\s+DBA|DBA\\s+|SALON|BARBERSHOP|BARBER|NAIL|SPA|BOUTIQUE|RESTAURANT|CAFE|COFFEE|PIZZA|TAQUERIA|DELI|BAKERY|DONUT|YOGA|FITNESS|GYM|SMOKE\\s*SHOP|VAPE|CONVENIENCE|GROCERY|MARKET|LIQUOR|PHARMACY|OPTICAL\\s+SHOP|EYEWEAR\\s+SHOP|PET\\s+GROOMING|AUTO\\s+DETAIL|CAR\\s+WASH|TATTOO|MASSAGE|DAYCARE|CHILDCARE|BEAUTY)\\b";
